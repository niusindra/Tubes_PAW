            ...
            <div class="columns">
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Slicked Back Undercut") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Long Comb + Low Fade") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Long Special Hairstyle") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Medium Side Swept") ?>>
                        <figure class="image">
            ...
            <div class="columns">
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Messy Taper Hairstyle") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Short Special Quiff") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Short Sides Long Top") ?>>
                        <figure class="image">  
            ...
            <div class="columns">
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Short Special Textured") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Slicked Back Wavy") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Textured Pompadour") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Textured Crop Top Fade") ?>>
                        <figure class="image">
            ...
            <div class="columns">
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Faux Hawk Fade") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Spiky Hair Special Fade") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Side Part + High Bald Fade") ?>>
                        <figure class="image">
                ...
                <div class="column">
                    <div class="tile is-parent">
                        ...
                        <a class="modal-button "data-target="#myModal" aria-haspopup="true" onclick=<?php setStyle("Slick Back With Flow") ?>>
                        <figure class="image">
            ...
            <div class="modal-background"></div>
                <div class="modal-content">
                    ...
                    <div class="control is-expanded" >
                        <div class="select">
                        <select>
                            <option><?php echo $clicked ?></option>
